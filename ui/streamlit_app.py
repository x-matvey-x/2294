...
from pipeline.pipeline import run_page
...
def main():
    ...
    if uploaded_file is not None:
        ...
        if st.session_state.total_pages > 1:
            ...
            with col_info:
                st.markdown(
                    f"<div style='text-align: center; background-color: transparent; padding: 10px; border-radius: 5px;'>Страница {current_page + 1} из {st.session_state.total_pages}</div>",
